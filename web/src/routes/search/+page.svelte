...
<div class="overflow-none h-screen w-screen bg-[#ffecc9] p-2">
	...
	<div class="mb-5 flex flex-col items-center">
		<form action="/search" class="w-full max-w-md">
			<input
				type="text"
				id="q"
				name="q"
				placeholder="Search our tree"
				class="inset-shadow-md h-[40px] w-full border-0 bg-[#ffecc9] text-sm inset-ring-3 inset-ring-[#9c6d17] placeholder:text-[#ab8f6c] focus-visible:ring-0 focus-visible:outline-none"
			/>
		</form>
	</div>
